          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label>Họ tên</label>
                <input maxlength="200" class="form-control" placeholder="Họ và Tên" name="name" type="text" data-validation-message="Chưa nhập thông tin này" data-validation="[NOTEMPTY]">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label>Ngày tháng năm sinh</label>
                <input type="text" class="form-control datepicker-only-init" name="dateOfBirth" data-validation-message="Chưa nhập thông tin này" data-validation="[NOTEMPTY]" />
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select class="form-control" name="gender" data-validation-message="Chưa nhập thông tin này" data-validation="[NOTEMPTY]">
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <select class="form-control" name="dist" data-validation-message="Chưa nhập thông tin này" data-validation="[NOTEMPTY]">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" maxlength="25" class="form-control phone" name="phone" placeholder="Số điện thoại">
              </div>
            </div>
          </div>
          <div class="row">
          ...
          <div class="modal-body">
            <div class="row">
              <div class="cropArea col-md-6 col-sm-6">
                <img-crop image="myImage" result-image="myCroppedImage" result-image-quality="1" result-image-size="500"></img-crop>
              </div>
