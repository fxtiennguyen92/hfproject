...
<nav class="top-menu">
  ...
  <div class="menu">
    <div class="menu-info-block">
      <div class="left">
        <div class="hf-logo">
          <a href="{{ route('home_page') }}"><img src="img/hf-logo.png" class="navbar-logo"></a>
        </div>
      </div>
    </div>
    <div class="menu-user-block">
      <div class="dropdown dropdown-avatar">
        ...
        <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="" role="menu">
          @if (auth()->user()->role == 0)
          <a class="dropdown-item" href="javascript: void(0);"><i class="dropdown-icon material-icons">&#xE87C;</i> Tài khoản</a>
          <a class="dropdown-item" href="{{ route('order_list_page') }}"><i class="dropdown-icon material-icons">&#xE24D;</i> Đơn hàng</a>
          @elseif (auth()->user()->role == 1)
          <a class="dropdown-item" href="javascript: void(0);"><i class="dropdown-icon material-icons">&#xE87C;</i> Tài khoản</a>
          <a class="dropdown-item" href="{{ route('pro_order_list_page') }}"><i class="dropdown-icon material-icons">&#xE24D;</i> Đơn hàng</a>
          ...
          @endif
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="{{ route('logout') }}"><i class="dropdown-icon material-icons">&#xE8AC;</i> Đăng xuất</a>
        </ul>
      </div>
    </div>
  </div>
